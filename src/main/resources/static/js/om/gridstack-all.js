        ...
        var e = {
                427: (e, t) => {
                    Object.defineProperty(t, "__esModule", { value: !0 }),
                        (t.DDBaseImplement = void 0),
                        (t.DDBaseImplement = class {
                            constructor() {
                                this._eventRegister = {};
                            }
                            get disabled() {
                ...
                186: (e, t, i) => {
                    ...
                    class l extends n.DDBaseImplement {
                        constructor(e, t = {}) {
                            ...
                            (this.dragEl = e.classList.contains(i) ? e : e.querySelector(t.handle) || e),
                        ...
                        enable() {
                            !1 !== this.disabled &&
                                ...
                                r.isTouch && (this.dragEl.addEventListener("touchstart", r.touchstart), this.dragEl.addEventListener("pointerdown", r.pointerdown)),
                        ...
                        disable(e = !1) {
                            !0 !== this.disabled &&
                                ...
                                r.isTouch && (this.dragEl.removeEventListener("touchstart", r.touchstart), this.dragEl.removeEventListener("pointerdown", r.pointerdown)),
                                this.el.classList.remove("ui-draggable"),
                                e || this.el.classList.add("ui-draggable-disabled"));
                        }
                        destroy() {
                            this.dragging && this._mouseUp(this.mouseDownEvent), this.disable(!0), delete this.el, delete this.helper, delete this.option, super.destroy();
                        }
                        updateOption(e) {
                        ...
                        _mouseDown(e) {
                            ...
                            let t = this.option.handle.substring(1),
                                i = e.target;
                            for (; i && !i.classList.contains(t); ) i = i.parentElement;
                            return i
                                ? ((this.mouseDownEvent = e),
                                  ...
                                  r.isTouch && (this.dragEl.addEventListener("touchmove", r.touchmove), this.dragEl.addEventListener("touchend", r.touchend)),
                                  e.preventDefault(),
                        ...
                        _mouseMove(e) {
                            ...
                            if (this.dragging) {
                                this._dragFollow(e);
                                const t = o.Utils.initEvent(e, { target: this.el, type: "drag" });
                                ...
                                i ? (s.DDManager.dropElement = i.el.ddElement.ddDroppable) : delete s.DDManager.dropElement,
                                    (this.helper = this._createHelper(e)),
                                    this._setupHelperContainmentStyle(),
                                    (this.dragOffset = this._getDragOffset(e, this.el, this.helperContainment));
                                const n = o.Utils.initEvent(e, { target: this.el, type: "dragstart" });
                        ...
                        _mouseUp(e) {
                            ...
                            if (
                                ...
                                r.isTouch && (this.dragEl.removeEventListener("touchmove", r.touchmove, !0), this.dragEl.removeEventListener("touchend", r.touchend, !0)),
                                this.dragging)
                            ) {
                                delete this.dragging,
                                    (null === (t = s.DDManager.dropElement) || void 0 === t ? void 0 : t.el) === this.el.parentElement && delete s.DDManager.dropElement,
                                    (this.helperContainment.style.position = this.parentOriginStylePosition || null),
                                    this.helper === this.el ? this._removeHelperStyle() : this.helper.remove();
                                const i = o.Utils.initEvent(e, { target: this.el, type: "dragstop" });
                        ...
                        _createHelper(e) {
                            let t = this.el;
                            return (
                                "function" == typeof this.option.helper ? (t = this.option.helper(e)) : "clone" === this.option.helper && (t = o.Utils.cloneNode(this.el)),
                                document.body.contains(t) || o.Utils.appendTo(t, "parent" === this.option.appendTo ? this.el.parentNode : this.option.appendTo),
                                t === this.el && (this.dragElementOriginStyle = l.originStyleProp.map((e) => this.el.style[e])),
                                t
                            );
                        }
                        _setupHelperStyle(e) {
                        ...
                        _getDragOffset(e, t, i) {
                            ...
                            if (i) {
                                ...
                                o.Utils.addElStyles(e, { opacity: "0", position: "fixed", top: "0px", left: "0px", width: "1px", height: "1px", zIndex: "-999999" }), i.appendChild(e);
                                const t = e.getBoundingClientRect();
                                i.removeChild(e), (s = t.left), (n = t.top);
                            }
                            const r = t.getBoundingClientRect();
                            return { left: r.left, top: r.top, offsetLeft: -e.clientX + r.left - s, offsetTop: -e.clientY + r.top - n, width: r.width, height: r.height };
                        }
                        ui() {
                            const e = this.el.parentElement.getBoundingClientRect(),
                                t = this.helper.getBoundingClientRect();
                            return { position: { top: t.top - e.top, left: t.left - e.left } };
                        }
                    }
                    ...
                    class l extends o.DDBaseImplement {
                        ...
                        enable() {
                            !1 !== this.disabled &&
                                ...
                                r.isTouch && (this.el.addEventListener("pointerenter", r.pointerenter), this.el.addEventListener("pointerleave", r.pointerleave)));
                        }
                        disable(e = !1) {
                            !0 !== this.disabled &&
                                (super.disable(),
                                ...
                                r.isTouch && (this.el.removeEventListener("pointerenter", r.pointerenter), this.el.removeEventListener("pointerleave", r.pointerleave)));
                        }
                        destroy() {
                        ...
                        _mouseEnter(e) {
                            ...
                            const t = n.Utils.initEvent(e, { target: this.el, type: "dropover" });
                        ...
                        _mouseLeave(e) {
                            ...
                            const i = n.Utils.initEvent(e, { target: this.el, type: "dropout" });
                        ...
                        drop(e) {
                            e.preventDefault();
                            const t = n.Utils.initEvent(e, { target: this.el, type: "drop" });
                        ...
                        _ui(e) {
                            return Object.assign({ draggable: e.el }, e.ui());
                        }
                    }
                    t.DDDroppable = l;
                },
                        ...
                        on(e, t) {
                            return (
                                this.ddDraggable && ["drag", "dragstart", "dragstop"].indexOf(e) > -1
                                    ...
                                    : this.ddResizable && ["resizestart", "resize", "resizestop"].indexOf(e) > -1 && this.ddResizable.on(e, t),
                                this
                            );
                        }
                        off(e) {
                            return (
                                this.ddDraggable && ["drag", "dragstart", "dragstop"].indexOf(e) > -1
                                    ...
                                    : this.ddResizable && ["resizestart", "resize", "resizestop"].indexOf(e) > -1 && this.ddResizable.off(e),
                                this
                            );
                        }
                        setupDraggable(e) {
                ...
                958: (e, t, i) => {
                    ...
                    class l {
                            ...
                            return (
                                this._getDDElements(e).forEach((e) => {
                                    if ("disable" === t || "enable" === t) e.ddResizable && e.ddResizable[t]();
                                        ...
                                        e.setupResizable(Object.assign(Object.assign(Object.assign({}, i.opts.resizable), { handles: s, autoHide: o }), { start: t.start, stop: t.stop, resize: t.resize }));
                                    }
                                }),
                                this
                            );
                            ...
                            return (
                                this._getDDElements(e).forEach((e) => {
                                    if ("disable" === t || "enable" === t) e.ddDraggable && e.ddDraggable[t]();
                                        ...
                                        const i = e.el.gridstackNode.grid;
                                        e.setupDraggable(Object.assign(Object.assign({}, i.opts.draggable), { start: t.start, stop: t.stop, drag: t.drag }));
                                    }
                                }),
                                this
                            );
                        ...
                        droppable(e, t, i, s) {
                            return (
                                "function" != typeof t.accept || t._accept || ((t._accept = t.accept), (t.accept = (e) => t._accept(e))),
                                this._getDDElements(e).forEach((e) => {
                                    "disable" === t || "enable" === t ? e.ddDroppable && e.ddDroppable[t]() : "destroy" === t ? e.ddDroppable && e.cleanDroppable() : "option" === t ? e.setupDroppable({ [i]: s }) : e.setupDroppable(t);
                                }),
                                this
                            );
                        }
                        ...
                        on(e, t, i) {
                            return (
                                this._getDDElements(e).forEach((e) =>
                                    e.on(t, (e) => {
                                        i(e, n.DDManager.dragElement ? n.DDManager.dragElement.el : e.target, n.DDManager.dragElement ? n.DDManager.dragElement.helper : null);
                                    })
                                ),
                                this
                            );
                        ...
                        _getDDElements(e, t = !0) {
                            let i = o.Utils.getElements(e);
                            if (!i.length) return [];
                            let s = i.map((e) => e.ddElement || (t ? r.DDElement.init(e) : null));
                    ...
                    (s.GridStack.prototype._setupAcceptWidget = function () {
                        if (this.opts.staticGrid || (!this.opts.acceptWidgets && !this.opts.removable)) return a.droppable(this.el, "destroy"), this;
                        let e,
                            t,
                            i = (i, s, n) => {
                                ...
                                let l = this.el.getBoundingClientRect(),
                                    { top: h, left: d } = n.getBoundingClientRect();
                                (d -= l.left), (h -= l.top);
                                let g = { position: { top: h, left: d } };
                                if (r._temporaryRemoved) {
                                    if (((r.x = Math.max(0, Math.round(d / t))), (r.y = Math.max(0, Math.round(h / e))), delete r.autoPosition, this.engine.nodeBoundFix(r), !this.engine.willItFit(r))) {
                                        if (((r.autoPosition = !0), !this.engine.willItFit(r))) return void a.off(s, "drag");
                                        r._willFitPos && (o.Utils.copyPos(r, r._willFitPos), delete r._willFitPos);
                                    }
                                    this._onStartMoving(n, i, g, r, t, e);
                                } else this._dragOrResize(n, i, g, r, t, e);
                            };
                        return (
                            a
                                .droppable(this.el, {
                                    accept: (e) => {
                                        ...
                                        if (null == t ? void 0 : t.subGrid) return !1;
                                        let i = !0;
                                ...
                                .on(this.el, "dropout", (e, t, i) => {
                                    ...
                                    return !!s && ((s.grid && s.grid !== this) || this._leave(t, i), !1);
                                })
                                .on(this.el, "drop", (e, t, i) => {
                                    ...
                                    let r = t._gridstackNodeOrig;
                                    if ((delete t._gridstackNodeOrig, n && r && r.grid && r.grid !== this)) {
                                        let e = r.grid;
                                        e.engine.removedNodes.push(r), e._triggerRemoveEvent();
                                    }
                                    return (
                                        !!s &&
                                        (n && (this.engine.cleanupNode(s), (s.grid = this)),
                                        a.off(t, "drag"),
                                        i !== t ? (i.remove(), (t.gridstackNode = r), n && (t = t.cloneNode(!0))) : (t.remove(), this._removeDD(t)),
                                        !!n &&
                                            ((t.gridstackNode = s),
                                            (s.el = t),
                                            o.Utils.copyPos(s, this._readAttr(this.placeholder)),
                                            ...
                                            this._gsEventHandler.dropped && this._gsEventHandler.dropped(Object.assign(Object.assign({}, e), { type: "dropped" }), r && r.grid ? r : void 0, s),
                                            window.setTimeout(() => {
                            ...
                            if (!this.opts.staticGrid && "string" == typeof this.opts.removable) {
                                ...
                                a.isDroppable(e) ||
                                    a
                                        ...
                                        .on(e, "dropover", (e, t) => h(t, !0))
                                        .on(e, "dropout", (e, t) => h(t, !1));
                            }
                            return this;
                        }),
                        (s.GridStack.setupDragIn = function (e, t) {
                            let i, s;
                            e && ((i = e), (s = Object.assign(Object.assign({}, { handle: ".grid-stack-item-content", appendTo: "body" }), t || {}))),
                                "string" == typeof i &&
                                    o.Utils.getElements(i).forEach((e) => {
                                        a.isDraggable(e) || a.dragIn(e, s);
                                    });
                        }),
                                    ...
                                    l = (i) => {
                                        ...
                                        if (s.gridstackNode && s.gridstackNode.grid === this) {
                                            if (((e.el = s), e._isAboutToRemove)) {
                                                ...
                                                o.Utils.removePositioningStyles(s),
                                                    e._temporaryRemoved ? (o.Utils.copyPos(e, e._orig), this._writePosAttr(s, e), this.engine.addNode(e)) : this._writePosAttr(s, e),
                                                    this._gsEventHandler[i.type] && this._gsEventHandler[i.type](i, s);
                                            (this._extraDragRow = 0), this._updateContainerHeight(), this._triggerChangeEvent(), this.engine.endUpdate();
                                        }
                                    };
                                a.draggable(t, { start: n, stop: l, drag: r }).resizable(t, { start: n, stop: l, resize: r }), (e._initDD = !0);
                            }
                            return a.draggable(t, i ? "disable" : "enable").resizable(t, s ? "disable" : "enable"), this;
                        }),
                        (s.GridStack.prototype._onStartMoving = function (e, t, i, s, o, n) {
                            this.engine.cleanNodes().beginUpdate(s),
                                ...
                                (s._moving = "dragstart" === t.type),
                                delete s._lastTried,
                                "dropover" === t.type && s._temporaryRemoved && (this.engine.addNode(s), (s._moving = !0)),
                                this.engine.cacheRects(o, n, this.opts.marginTop, this.opts.marginRight, this.opts.marginBottom, this.opts.marginLeft),
                                "resizestart" === t.type &&
                                    (a.resizable(e, "option", "minWidth", o * (s.minW || 1)).resizable(e, "option", "minHeight", n * (s.minH || 1)),
                                    s.maxW && a.resizable(e, "option", "maxWidth", o * s.maxW),
                                    s.maxH && a.resizable(e, "option", "maxHeight", n * s.maxH));
                        }),
                        (s.GridStack.prototype._leave = function (e, t) {
                            ...
                            i &&
                                ...
                                i._temporaryRemoved ||
                                    ...
                                    !0 === this.opts.removable && h(e, !0),
                                    e._gridstackNodeOrig ? ((e.gridstackNode = e._gridstackNodeOrig), delete e._gridstackNodeOrig) : i._isExternal && (delete i.el, delete e.gridstackNode, this.engine.restoreInitial())));
                        }),
                        (s.GridStack.prototype._dragOrResize = function (e, t, i, s, n, r) {
                            let l,
                            ...
                            if (((h = Math.min(h, c)), (d = Math.min(d, c)), (g = Math.min(g, u)), (p = Math.min(p, u)), "drag" === t.type)) {
                                ...
                                (s._prevYPix = i.position.top), o.Utils.updateScrollPosition(e, i.position, t);
                                ...
                                (a.x = Math.round(l / n)), (a.y = Math.round(u / r));
                                ...
                                if (a.x < 0) return;
                                if ((o.Utils.updateScrollResize(t, e, r), (a.w = Math.round((i.size.width - h) / n)), (a.h = Math.round((i.size.height - g) / r)), s.w === a.w && s.h === a.h)) return;
                                if (s._lastTried && s._lastTried.w === a.w && s._lastTried.h === a.h) return;
                                let d = i.position.left + h,
                                    p = i.position.top + g;
                                (a.x = Math.round(d / n)), (a.y = Math.round(p / r)), (l = !0);
                            }
                            s._lastTried = a;
                            let m = { x: i.position.left + h, y: i.position.top + g, w: (i.size ? i.size.width : s.w * n) - h - d, h: (i.size ? i.size.height : s.h * r) - g - p };
                            if (this.engine.moveNodeCheck(s, Object.assign(Object.assign({}, a), { cellWidth: n, cellHeight: r, rect: m, resizing: l }))) {
                                (s._lastUiPosition = i.position), this.engine.cacheRects(n, r, g, d, p, h), delete s._skipDown, l && s.subGrid && s.subGrid.onParentResize(), (this._extraDragRow = 0), this._updateContainerHeight();
                                let e = t.target;
                        ...
                        (s.GridStack.prototype.movable = function (e, t) {
                            return (
                                this.opts.staticGrid ||
                                    s.GridStack.getElements(e).forEach((e) => {
                                        let i = e.gridstackNode;
                        ...
                        (s.GridStack.prototype._removeDD = function (e) {
                            return a.draggable(e, "destroy").resizable(e, "destroy"), e.gridstackNode && delete e.gridstackNode._initDD, this;
                        });
                },
                939: (e, t) => {
                    Object.defineProperty(t, "__esModule", { value: !0 }), (t.DDManager = void 0), (t.DDManager = class {});
                },
                41: (e, t, i) => {
                    ...
                    class o {
                        ...
                        _init() {
                            ...
                            return (
                                ...
                                e.classList.add(`${o.prefix}${this.dir}`),
                                (e.style.zIndex = "100"),
                                (e.style.userSelect = "none"),
                                (this.el = e),
                                this.host.appendChild(this.el),
                                this.el.addEventListener("mousedown", this._mouseDown),
                                s.isTouch && (this.el.addEventListener("touchstart", s.touchstart), this.el.addEventListener("pointerdown", s.pointerdown)),
                                this
                            );
                        }
                        destroy() {
                            return (
                                ...
                                s.isTouch && (this.el.removeEventListener("touchstart", s.touchstart), this.el.removeEventListener("pointerdown", s.pointerdown)),
                        ...
                        _mouseDown(e) {
                            (this.mouseDownEvent = e),
                                document.addEventListener("mousemove", this._mouseMove, !0),
                                document.addEventListener("mouseup", this._mouseUp, !0),
                                s.isTouch && (this.el.addEventListener("touchmove", s.touchmove), this.el.addEventListener("touchend", s.touchend)),
                                e.stopPropagation(),
                                e.preventDefault();
                        }
                        _mouseMove(e) {
                            let t = this.mouseDownEvent;
                            this.moving ? this._triggerEvent("move", e) : Math.abs(e.x - t.x) + Math.abs(e.y - t.y) > 2 && ((this.moving = !0), this._triggerEvent("start", this.mouseDownEvent), this._triggerEvent("move", e)),
                                e.stopPropagation(),
                                e.preventDefault();
                        }
                        _mouseUp(e) {
                            this.moving && this._triggerEvent("stop", e),
                                document.removeEventListener("mousemove", this._mouseMove, !0),
                                document.removeEventListener("mouseup", this._mouseUp, !0),
                                s.isTouch && (this.el.removeEventListener("touchmove", s.touchmove), this.el.removeEventListener("touchend", s.touchend)),
                                delete this.moving,
                    ...
                    class l extends o.DDBaseImplement {
                        constructor(e, t = {}) {
                            super(),
                                (this._ui = () => {
                                    const e = this.el.parentElement.getBoundingClientRect(),
                                        t = { width: this.originalRect.width, height: this.originalRect.height + this.scrolled, left: this.originalRect.left, top: this.originalRect.top - this.scrolled },
                                        i = this.temporalRect || t;
                                    return { position: { left: i.left - e.left, top: i.top - e.top }, size: { width: i.width, height: i.height } };
                                }),
                                (this.el = e),
                                (this.option = t),
                        ...
                        _setupAutoHide(e) {
                            return (
                                e
                                    ? (this.el.classList.add("ui-resizable-autohide"), this.el.addEventListener("mouseover", this._mouseOver), this.el.addEventListener("mouseout", this._mouseOut))
                                    : (this.el.classList.remove("ui-resizable-autohide"),
                                      this.el.removeEventListener("mouseover", this._mouseOver),
                                      this.el.removeEventListener("mouseout", this._mouseOut),
                                      r.DDManager.overResizeElement === this && delete r.DDManager.overResizeElement),
                                this
                            );
                        }
                        _mouseOver(e) {
                        ...
                        _setupHandlers() {
                            ...
                            return (
                                "all" === e && (e = "n,e,s,w,se,sw,ne,nw"),
                                (this.handlers = e
                                    .split(",")
                                    .map((e) => e.trim())
                                    .map(
                                        (e) =>
                                            new s.DDResizableHandle(this.el, e, {
                                                start: (e) => {
                                                    this._resizeStart(e);
                                                },
                                                stop: (e) => {
                        ...
                        _resizeStart(e) {
                            (this.originalRect = this.el.getBoundingClientRect()),
                                ...
                                this._setupHelper(),
                                this._applyChange();
                            const t = n.Utils.initEvent(e, { type: "resizestart", target: this.el });
                        ...
                        _resizing(e, t) {
                            ...
                            const i = n.Utils.initEvent(e, { type: "resize", target: this.el });
                            return this.option.resize && this.option.resize(i, this._ui()), this.triggerEvent("resize", i), this;
                        }
                        _resizeStop(e) {
                            const t = n.Utils.initEvent(e, { type: "resizestop", target: this.el });
                            return (
                        ...
                        _setupHelper() {
                            return (
                                (this.elOriginStyleVal = l._originStyleProp.map((e) => this.el.style[e])),
                        ...
                        _cleanHelper() {
                            return (
                                l._originStyleProp.forEach((e, t) => {
                        ...
                        _getChange(e, t) {
                            ...
                            return (
                                Math.round(s.width) !== Math.round(r.width) && (t.indexOf("w") > -1 && (s.left += s.width - r.width), (s.width = r.width)),
                                Math.round(s.height) !== Math.round(r.height) && (t.indexOf("n") > -1 && (s.top += s.height - r.height), (s.height = r.height)),
                                s
                            );
                        }
                        _constrainSize(e, t) {
                            ...
                            return { width: Math.min(i, Math.max(s, e)), height: Math.min(o, Math.max(n, t)) };
                        }
                        _applyChange() {
                ...
                635: (e, t, i) => {
                    ...
                    const s = i(939);
                    t.isTouch = "ontouchstart" in document || "ontouchstart" in window || (window.DocumentTouch && document instanceof window.DocumentTouch) || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0;
                    class o {}
                    function n(e, t) {
                    ...
                    (t.touchstart = function (e) {
                        ...
                        (t.pointerleave = function (e) {
                            s.DDManager.dragElement &&
                                (o.pointerLeaveTimeout = window.setTimeout(() => {
                ...
                62: (e, t, i) => {
                    ...
                    class o {
                        ...
                        batchUpdate(e = !0) {
                            return (
                                !!this.batchMode === e ||
                                    ((this.batchMode = e), e ? ((this._prevFloat = this._float), (this._float = !0), this.saveInitial()) : ((this._float = this._prevFloat), delete this._prevFloat, this._packNodes()._notify())),
                                this
                            );
                        }
                        ...
                        _fixCollisions(e, t = e, i, o = {}) {
                            ...
                            let n = t;
                            this._useEntireRowArea(e, t) && ((n = { x: 0, w: this.column, y: t.y, h: t.h }), (i = this.collide(e, n, o.skip)));
                            let r = !1,
                                l = { nested: !0, pack: !1 };
                            for (; (i = i || this.collide(e, n, o.skip)); ) {
                                ...
                                if (
                                    ...
                                    (e._moving &&
                                        ...
                                        t.y > e.y &&
                                        !this.float &&
                                        (!this.collide(i, Object.assign(Object.assign({}, i), { y: e.y }), e) || !this.collide(i, Object.assign(Object.assign({}, i), { y: t.y - i.h }), e)))
                                        ? ((e._skipDown = e._skipDown || t.y > e.y),
                                          (n = this.moveNode(e, Object.assign(Object.assign(Object.assign({}, t), { y: i.y + i.h }), l))),
                                          i.locked && n ? s.Utils.copyPos(t, e) : !i.locked && n && o.pack && (this._packNodes(), (t.y = i.y + i.h), s.Utils.copyPos(e, t)),
                                          (r = r || n))
                                        : (n = this.moveNode(i, Object.assign(Object.assign(Object.assign({}, i), { y: t.y + t.h, skip: e }), l))),
                                    !n)
                                )
                                    return r;
                                i = void 0;
                        ...
                        cacheRects(e, t, i, s, o, n) {
                            return this.nodes.forEach((r) => (r._rect = { y: r.y * t + i, x: r.x * e + n, w: r.w * e - n - s, h: r.h * t - i - o })), this;
                        }
                        swap(e, t) {
                                ...
                                this.batchMode ||
                                    ...
                                    this.float
                                        ? this.nodes.forEach((e) => {
                                              ...
                                              let t = e.y;
                                              for (; t > e._orig.y; ) --t, this.collide(e, { x: e.x, y: t, w: e.w, h: e.h }) || ((e._dirty = !0), (e.y = t));
                                          })
                        ...
                        nodeBoundFix(e, t) {
                            ...
                            return (
                                ...
                                e.w > this.column ? (this.column < 12 && !this._inColumnResize && ((e.w = Math.min(12, e.w)), this.cacheOneLayout(e, 12)), (e.w = this.column)) : e.w < 1 && (e.w = 1),
                                this.maxRow && e.h > this.maxRow ? (e.h = this.maxRow) : e.h < 1 && (e.h = 1),
                                e.x < 0 && (e.x = 0),
                                e.y < 0 && (e.y = 0),
                                e.x + e.w > this.column && (t ? (e.w = this.column - e.x) : (e.x = this.column - e.w)),
                                this.maxRow && e.y + e.h > this.maxRow && (t ? (e.h = this.maxRow - e.y) : (e.y = this.maxRow - e.h)),
                                s.Utils.samePos(e, i) || (e._dirty = !0),
                                e
                            );
                        }
                        getDirtyNodes(e) {
                        ...
                        addNode(e, t = !1) {
                            ...
                            if (i) return i;
                            if ((delete (e = this._inColumnResize ? this.nodeBoundFix(e) : this.prepareNode(e))._temporaryRemoved, delete e._removeDOM, e.autoPosition)) {
                                this.sortNodes();
                                for (let t = 0; ; ++t) {
                                    let i = t % this.column,
                                        o = Math.floor(t / this.column);
                                    if (i + e.w > this.column) continue;
                                    let n = { x: i, y: o, w: e.w, h: e.h };
                                    if (!this.nodes.find((e) => s.Utils.isIntercepted(n, e))) {
                                        (e.x = i), (e.y = o), delete e.autoPosition;
                                        break;
                                    }
                                }
                            }
                            return this.nodes.push(e), t && this.addedNodes.push(e), this._fixCollisions(e), this.batchMode || this._packNodes()._notify(), e;
                        }
                        ...
                        moveNodeCheck(e, t) {
                            ...
                            let i,
                                n = new o({ column: this.column, float: this.float, nodes: this.nodes.map((t) => (t === e ? ((i = Object.assign({}, t)), i) : Object.assign({}, t))) });
                            if (!i) return !1;
                            let r = n.moveNode(i, t);
                            if (!t.resizing && r && t.collide && this.float && n.getRow() > this.maxRow) {
                        ...
                        willItFit(e) {
                            ...
                            let t = new o({ column: this.column, float: this.float, nodes: this.nodes.map((e) => Object.assign({}, e)) }),
                                i = Object.assign({}, e);
                        ...
                        changedPosConstrain(e, t) {
                            return (
                                ...
                                e.x !== t.x ||
                                    e.y !== t.y ||
                                    (e.maxW && (t.w = Math.min(t.w, e.maxW)), e.maxH && (t.h = Math.min(t.h, e.maxH)), e.minW && (t.w = Math.max(t.w, e.minW)), e.minH && (t.h = Math.max(t.h, e.minH)), e.w !== t.w || e.h !== t.h)
                            );
                        }
                        moveNode(e, t) {
                            if (!e || !t) return !1;
                            ...
                            let i = e.w !== t.w || e.h !== t.h,
                                o = s.Utils.copyPos({}, e, !0);
                            if ((s.Utils.copyPos(o, t), (o = this.nodeBoundFix(o, i)), s.Utils.copyPos(t, o), s.Utils.samePos(e, t))) return !1;
                            let n = s.Utils.copyPos({}, e),
                                r = this.collideAll(e, o, t.skip),
                                l = !0;
                            if (r.length) {
                                let i = e._moving && !t.nested ? this.collideCoverage(e, t, r) : r[0];
                                l = !!i && !this._fixCollisions(e, o, i, t);
                            }
                            return l && ((e._dirty = !0), s.Utils.copyPos(e, o)), t.pack && this._packNodes()._notify(), !s.Utils.samePos(e, n);
                        }
                        getRow() {
                        ...
                        save(e = !0) {
                            ...
                            return (
                                ...
                                this.nodes.forEach((t) => {
                                    let i = null == s ? void 0 : s.find((e) => e._id === t._id),
                                        n = Object.assign({}, t);
                                    i && ((n.x = i.x), (n.y = i.y), (n.w = i.w));
                                    for (let e in n) ("_" !== e[0] && null !== n[e] && void 0 !== n[e]) || delete n[e];
                                    delete n.grid, e || delete n.el, n.autoPosition || delete n.autoPosition, n.noResize || delete n.noResize, n.noMove || delete n.noMove, n.locked || delete n.locked, o.push(n);
                                }),
                                o
                            );
                        }
                        ...
                        updateNodeWidths(e, t, i, o = "moveScale") {
                            ...
                            if (t > e) {
                                ...
                                !a.length &&
                                    e !== s &&
                                    (null === (n = this._layouts[s]) || void 0 === n ? void 0 : n.length) &&
                                    ((e = s),
                            ...
                            if (
                                (a.forEach((e) => {
                                    ...
                                    -1 !== t && ((i[t].x = e.x), (i[t].y = e.y), (i[t].w = e.w), r.push(i[t]), i.splice(t, 1));
                                }),
                                i.length)
                            )
                        ...
                        cacheLayout(e, t, i = !1) {
                            ...
                            return (
                                e.forEach((e, t) => {
                                    (e._id = e._id || o._idSeq++), (s[t] = { x: e.x, y: e.y, w: e.w, _id: e._id });
                                }),
                        ...
                        cacheOneLayout(e, t) {
                            ...
                            let s = this._layouts[t].findIndex((t) => t._id === e._id);
                ...
                270: function (e, t, i) {
                    ...
                    class a {
                        constructor(e, t = {}) {
                            ...
                            let i = r.Utils.toNumber(e.getAttribute("gs-row"));
                            "auto" === t.column && delete t.column;
                            let s = t;
                            void 0 !== s.minWidth && ((t.oneColumnSize = t.oneColumnSize || s.minWidth), delete s.minWidth), void 0 !== t.alwaysShowResizeHandle && (t._alwaysShowResizeHandle = t.alwaysShowResizeHandle);
                            let o = Object.assign(Object.assign({}, r.Utils.cloneDeep(l.GridDefaults)), {
                                column: r.Utils.toNumber(e.getAttribute("gs-column")) || l.GridDefaults.column,
                                minRow: i || r.Utils.toNumber(e.getAttribute("gs-min-row")) || l.GridDefaults.minRow,
                                maxRow: i || r.Utils.toNumber(e.getAttribute("gs-max-row")) || l.GridDefaults.maxRow,
                                staticGrid: r.Utils.toBool(e.getAttribute("gs-static")) || l.GridDefaults.staticGrid,
                                draggable: { handle: (t.handleClass ? "." + t.handleClass : t.handle ? t.handle : "") || l.GridDefaults.draggable.handle },
                                removableOptions: { accept: t.itemClass ? "." + t.itemClass : l.GridDefaults.removableOptions.accept },
                            });
                            e.getAttribute("gs-animate") && (o.animate = r.Utils.toBool(e.getAttribute("gs-animate"))),
                                (this.opts = r.Utils.defaults(t, o)),
                                (t = null),
                                this._initMargin(),
                                1 !== this.opts.column && !this.opts.disableOneColumnMode && this._widthOrContainer() <= this.opts.oneColumnSize && ((this._prevColumn = this.getColumn()), (this.opts.column = 1)),
                                "auto" === this.opts.rtl && (this.opts.rtl = "rtl" === e.style.direction),
                                this.opts.rtl && this.el.classList.add("grid-stack-rtl");
                            let d = r.Utils.closestByClass(this.el, l.GridDefaults.itemClass);
                            d && d.gridstackNode && ((this._isNested = d.gridstackNode), (this._isNested.subGrid = this), d.classList.add("grid-stack-nested"), this.el.classList.add("grid-stack-nested")),
                                ...
                                this._isAutoCellHeight || "initial" === this.opts.cellHeight
                                    ...
                                    : ("number" == typeof this.opts.cellHeight &&
                                          ...
                                          this.opts.cellHeightUnit !== l.GridDefaults.cellHeightUnit &&
                                          ((this.opts.cellHeight = this.opts.cellHeight + this.opts.cellHeightUnit), delete this.opts.cellHeightUnit),
                                      this.cellHeight(this.opts.cellHeight, !1)),
                                "mobile" === this.opts.alwaysShowResizeHandle && (this.opts.alwaysShowResizeHandle = h.isTouch),
                                (this._styleSheetClass = "grid-stack-instance-" + (1e4 * Math.random()).toFixed(0)),
                                this.el.classList.add(this._styleSheetClass),
                                this._setStaticClass();
                            let g = this.opts.engineClass || a.engineClass || n.GridStackEngine;
                            if (
                                ((this.engine = new g({
                                ...
                                this.getGridItems().forEach((t) => {
                                    let i = parseInt(t.getAttribute("gs-x")),
                                        s = parseInt(t.getAttribute("gs-y"));
                                    e.push({ el: t, i: (Number.isNaN(i) ? 1e3 : i) + (Number.isNaN(s) ? 1e3 : s) * this.getColumn() });
                                }),
                                    e.sort((e, t) => e.i - t.i).forEach((e) => this._prepareElement(e.el)),
                                    this.batchUpdate(!1);
                            }
                            this.setAnimation(this.opts.animate),
                                this._updateStyles(),
                                12 != this.opts.column && this.el.classList.add("grid-stack-" + this.opts.column),
                                this.opts.dragIn && a.setupDragIn(this.opts.dragIn, this.opts.dragInOptions),
                        ...
                        static init(e = {}, t = ".grid-stack") {
                            ...
                            return i
                                ? (i.gridstack || (i.gridstack = new a(i, r.Utils.cloneDeep(e))), i.gridstack)
                                : ("string" == typeof t
                                      ? console.error(
                        ...
                        get placeholder() {
                            if (!this._placeholder) {
                                ...
                                (e.className = "placeholder-content"),
                                    ...
                                    this._placeholder.classList.add(this.opts.placeholderClass, l.GridDefaults.itemClass, this.opts.itemClass),
                        ...
                        addWidget(e, t) {
                            if (arguments.length > 2) {
                                ...
                                let t = arguments,
                                    i = 1,
                                    s = { x: t[i++], y: t[i++], w: t[i++], h: t[i++], autoPosition: t[i++], minW: t[i++], maxW: t[i++], minH: t[i++], maxH: t[i++], id: t[i++] };
                                return this.addWidget(e, s);
                            }
                            let i;
                            if ("string" == typeof e) {
                            ...
                            if ((this._writeAttr(i, t), this._insertNotAppend ? this.el.prepend(i) : this.el.appendChild(i), this._prepareElement(i, !0, t), this._updateContainerHeight(), n.subGrid && !n.subGrid.el)) {
                                let e,
                                    t = n.subGrid;
                                "auto" === t.column && ((t.column = n.w), (t.disableOneColumnMode = !0), (e = !0));
                                let i = n.el.querySelector(".grid-stack-item-content");
                                (n.subGrid = a.addGrid(i, n.subGrid)), e && (n.subGrid._autoColumn = !0);
                            }
                            ...
                            if (
                                (i.forEach((t) => {
                                    if (e && t.el && !t.subGrid) {
                                        ...
                                        let ch = t.el.clientHeight - 25;
                                        let ksw = "<div class='grid-stack-item-content'><div id='"+t.id+"'  style='height:"+ch+"px;'></div></div>";
                                        if(t.progid=="omm1" || t.progid=="oms2")
                                        	(t.content = e ? ksw : void 0), t.content || delete t.content;
                                        else 
                                ...
                                e.marginBottom === e.marginTop &&
                                    ...
                                    ((e.margin = e.marginTop), delete e.marginTop, delete e.marginRight, delete e.marginBottom, delete e.marginLeft),
                                    e.rtl === ("rtl" === this.el.style.direction) && (e.rtl = "auto"),
                                    this._isAutoCellHeight && (e.cellHeight = "auto"),
                                    this._autoColumn && ((e.column = "auto"), delete e.disableOneColumnMode);
                        ...
                        load(e, t = !0) {
                            ...
                            (this._insertNotAppend = !0),
                                this._prevColumn && this._prevColumn !== this.opts.column && i.some((e) => e.x + e.w > this.opts.column) && ((this._ignoreLayoutsNodeChange = !0), this.engine.cacheLayout(i, this._prevColumn, !0));
                            let s = [];
                            return (
                                this.batchUpdate(),
                                t &&
                        ...
                        cellHeight(e, t = !0) {
                            if (
                                (t && void 0 !== e && this._isAutoCellHeight !== ("auto" === e) && ((this._isAutoCellHeight = "auto" === e), this._updateWindowResizeEvent()), ("initial" !== e && "auto" !== e) || (e = void 0), void 0 === e)
                            ) {
                        ...
                        column(e, t = "moveScale") {
                            ...
                            let i,
                                s = this.getColumn();
                            return (
                                1 === e ? (this._prevColumn = s) : delete this._prevColumn,
                                ...
                                1 === e &&
                                    ...
                                    i.length || (i = void 0)),
                                this.engine.updateNodeWidths(s, e, i, t),
                        ...
                        destroy(e = !0) {
                            if (this.el)
                                return (
                                    ...
                                    this.setStatic(!0, !1),
                                    this.setAnimation(!1),
                                    e ? this.el.parentNode.removeChild(this.el) : (this.removeAll(e), this.el.classList.remove(this._styleSheetClass)),
                        ...
                        on(e, t) {
                            ...
                            if ("change" === e || "added" === e || "removed" === e || "enable" === e || "disable" === e) {
                                ...
                                "drag" === e || "dragstart" === e || "dragstop" === e || "resizestart" === e || "resize" === e || "resizestop" === e || "dropped" === e
                                    ? (this._gsEventHandler[e] = t)
                                    : console.log("GridStack.on(" + e + ') event not supported, but you can still use $(".grid-stack").on(...) while jquery-ui is still used internally.');
                            return this;
                        }
                        off(e) {
                            return -1 !== e.indexOf(" ")
                                ? (e.split(" ").forEach((e) => this.off(e)), this)
                                : (("change" !== e && "added" !== e && "removed" !== e && "enable" !== e && "disable" !== e) || (this._gsEventHandler[e] && this.el.removeEventListener(e, this._gsEventHandler[e])),
                                  delete this._gsEventHandler[e],
                                  this);
                        }
                        removeWidget(e, t = !0, i = !0) {
                            return (
                                a.getElements(e).forEach((e) => {
                        ...
                        setStatic(e, t = !0) {
                            return (
                                this.opts.staticGrid === e || ((this.opts.staticGrid = e), this._setupRemoveDrop(), this._setupAcceptWidget(), this.engine.nodes.forEach((e) => this._prepareDragDropByNode(e)), t && this._setStaticClass()),
                                this
                            );
                        }
                        update(e, t) {
                            ...
                            return (
                                a.getElements(e).forEach((e) => {
                                    ...
                                    o && (this.engine.cleanNodes().beginUpdate(i).moveNode(i, o), this._updateContainerHeight(), this._triggerChangeEvent(), this.engine.endUpdate()),
                                        l && this._writeAttr(e, i),
                        ...
                        _updateStyles(e = !1, t) {
                            ...
                            if (!this._styles) {
                                ...
                                (this._styles._id = e), (this._styles._max = 0), r.Utils.addCSSRule(this._styles, o, `min-height: ${i}${s}`);
                                let n = this.opts.marginTop + this.opts.marginUnit,
                                    ...
                                    g = `.${this._styleSheetClass} > .grid-stack-placeholder > .placeholder-content`;
                                r.Utils.addCSSRule(this._styles, d, `top: ${n}; right: ${a}; bottom: ${l}; left: ${h};`),
                                    r.Utils.addCSSRule(this._styles, g, `top: ${n}; right: ${a}; bottom: ${l}; left: ${h};`),
                                    r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-ne`, `right: ${a}`),
                                    r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-e`, `right: ${a}`),
                                    r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-se`, `right: ${a}; bottom: ${l}`),
                                    r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-nw`, `left: ${h}`),
                                    r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-w`, `left: ${h}`),
                                    r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-sw`, `left: ${h}; bottom: ${l}`);
                            }
                            if ((t = t || this._styles._max) > this._styles._max) {
                                let e = (e) => i * e + s;
                                for (let i = this._styles._max + 1; i <= t; i++) {
                                    let t = e(i);
                                    r.Utils.addCSSRule(this._styles, `${o}[gs-y="${i - 1}"]`, `top: ${e(i - 1)}`),
                                        r.Utils.addCSSRule(this._styles, `${o}[gs-h="${i}"]`, `height: ${t}`),
                                        r.Utils.addCSSRule(this._styles, `${o}[gs-min-h="${i}"]`, `min-height: ${t}`),
                                        r.Utils.addCSSRule(this._styles, `${o}[gs-max-h="${i}"]`, `max-height: ${t}`);
                                }
                                this._styles._max = t;
                            }
                            return this;
                        ...
                        _readAttr(e) {
                            ...
                            (t.x = r.Utils.toNumber(e.getAttribute("gs-x"))),
                                ...
                                (t.progid = e.getAttribute("gs-progid")),
                                (t.wzid = e.getAttribute("gs-wzid")),
                        ...
                        onParentResize() {
                            ...
                            let e = !1;
                            if (this._autoColumn && this._isNested) this.opts.column !== this._isNested.w && ((e = !0), this.column(this._isNested.w, "none"));
                            else {
                            ...
                            return (
                                this._isAutoCellHeight &&
                                    (!e && this.opts.cellHeightThrottle
                                        ? (this._cellHeightThrottle || (this._cellHeightThrottle = r.Utils.throttle(() => this.cellHeight(), this.opts.cellHeightThrottle)), this._cellHeightThrottle())
                                        : this.cellHeight()),
                                this.engine.nodes.forEach((e) => {
                        ...
                        _updateWindowResizeEvent(e = !1) {
                            const t = (this._isAutoCellHeight || !this.opts.disableOneColumnMode) && !this._isNested;
                            return (
                                e || !t || this._windowResizeBind
                                    ? (!e && t) || !this._windowResizeBind || (window.removeEventListener("resize", this._windowResizeBind), delete this._windowResizeBind)
                                    : ((this._windowResizeBind = this.onParentResize.bind(this)), window.addEventListener("resize", this._windowResizeBind)),
                                this
                            );
                        }
                        ...
                        _initMargin() {
                            ...
                            return (
                                ...
                                2 === i.length
                                    ? ((this.opts.marginTop = this.opts.marginBottom = i[0]), (this.opts.marginLeft = this.opts.marginRight = i[1]))
                                    : 4 === i.length
                                    ? ((this.opts.marginTop = i[0]), (this.opts.marginRight = i[1]), (this.opts.marginBottom = i[2]), (this.opts.marginLeft = i[3]))
                                    : ((e = r.Utils.parseHeight(this.opts.margin)), (this.opts.marginUnit = e.unit), (t = this.opts.margin = e.h)),
                                void 0 === this.opts.marginTop ? (this.opts.marginTop = t) : ((e = r.Utils.parseHeight(this.opts.marginTop)), (this.opts.marginTop = e.h), delete this.opts.margin),
                                void 0 === this.opts.marginBottom ? (this.opts.marginBottom = t) : ((e = r.Utils.parseHeight(this.opts.marginBottom)), (this.opts.marginBottom = e.h), delete this.opts.margin),
                                void 0 === this.opts.marginRight ? (this.opts.marginRight = t) : ((e = r.Utils.parseHeight(this.opts.marginRight)), (this.opts.marginRight = e.h), delete this.opts.margin),
                                void 0 === this.opts.marginLeft ? (this.opts.marginLeft = t) : ((e = r.Utils.parseHeight(this.opts.marginLeft)), (this.opts.marginLeft = e.h), delete this.opts.margin),
                    ...
                    (t.GridStack = a), (a.Utils = r.Utils), (a.Engine = n.GridStackEngine), (a.GDRev = "6.0.2");
                    const h = i(635);
                    o(i(958), t);
                },
                699: (e, t) => {
                    Object.defineProperty(t, "__esModule", { value: !0 }),
                        (t.GridDefaults = void 0),
                        (t.GridDefaults = {
                ...
                593: (e, t) => {
                    Object.defineProperty(t, "__esModule", { value: !0 }),
                        (t.Utils = t.obsoleteAttr = t.obsoleteOptsDel = t.obsoleteOpts = t.obsolete = void 0),
                        (t.obsolete = function (e, t, i, s, o) {
                        ...
                        (t.obsoleteAttr = function (e, t, i, s) {
                            ...
                            null !== o &&
                                (e.setAttribute(i, o),
                                console.warn("gridstack.js: attribute `" + t + "`=" + o + " is deprecated on this object in " + s + " and has been replaced with `" + i + "`. It will be **removed** in a future release"));
                        });
                    class i {
                        ...
                        static isTouching(e, t) {
                            return i.isIntercepted(e, { x: t.x - 0.5, y: t.y - 0.5, w: t.w + 1, h: t.h + 1 });
                        }
                        static sort(e, t, i) {
                        ...
                        static updateScrollPosition(e, t, i) {
                            ...
                            if (s.top < 0 || s.bottom > o) {
                                ...
                                if (null !== l) {
                                    let a = l.scrollTop;
                                    s.top < 0 && i < 0 ? (e.offsetHeight > o ? (l.scrollTop += i) : (l.scrollTop += Math.abs(r) > Math.abs(i) ? i : r)) : i > 0 && (e.offsetHeight > o ? (l.scrollTop += i) : (l.scrollTop += n > i ? i : n)),
                                        (t.top += l.scrollTop - a);
                                }
                            }
                        }
                        static updateScrollResize(e, t, i) {
                            const s = this.getScrollElement(t),
                                ...
                                r = e.clientY - n,
                                l = r > o - i;
                            r < i ? s.scrollBy({ behavior: "smooth", top: r - i }) : l && s.scrollBy({ behavior: "smooth", top: i - (o - r) });
                        }
                        static clone(e) {
                            return null == e || "object" != typeof e ? e : e instanceof Array ? [...e] : Object.assign({}, e);
                        }
                        static cloneDeep(e) {
                            const t = ["_isNested", "el", "grid", "subGrid", "engine"],
                                s = i.clone(e);
                        ...
                        static initEvent(e, t) {
                            const i = { type: t.type },
                                s = { button: 0, which: 0, buttons: 1, bubbles: !0, cancelable: !0, target: t.target ? t.target : e.target };
                            return (
                                e.dataTransfer && (i.dataTransfer = e.dataTransfer),
                                ["altKey", "ctrlKey", "metaKey", "shiftKey"].forEach((t) => (i[t] = e[t])),
                                ["pageX", "pageY", "clientX", "clientY", "screenX", "screenY"].forEach((t) => (i[t] = e[t])),

	...
	json.forEach((item)=>{
	    ...
	    if(valMenulvl != 0  ) {	  
	    	if(menugbn =='FLD' ){
	    		...
	    		addDHtml += "<LI><a mid='"+progrid+"' funurl='"+progcmd+"' title='"+menunam+"'  href='/main/singlePageCMD.do?gprogcmd="+progcmd+"&gprogrid="+progrid+"&gnatitle="+menunam+"'><p"+newMenulvl+">"+ ' '+menunam + "</p"+newMenulvl+"></a></LI>";	   
	    	}
	    } else {

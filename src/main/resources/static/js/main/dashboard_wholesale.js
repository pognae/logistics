...
function setChartWb1(chartid){	 
	...
	option = {
  		...
  		yAxis: { type: 'category',
    		data: yData // ['Brazil', 'Indonesia', 'USA', 'India', 'China', 'World']
		},
		series: [
					{
      				name: '지난주',
	...
	var sData2 = [120, 289, 234, 970, 114, 630];
		...
		option = { 
  			...
  			series: [
				...
				data: [
					{ value: 40, name: '.기모)네명MTM_백메란F' },
					{ value: 38, name: '기모)독수리MTM' },
					{ value: 32, name: '기모)레몬MTM' },
					{ value: 30, name: '기모)스페셜카라MTM_수박' },
					{ value: 28, name: '기모)스피크MTM_검정F' },
					{ value: 26, name: '스피크MTM_검정 6' },
					{ value: 22, name: '스피크MTM_검정 7' },
					{ value: 18, name: '스피크MTM_검정 8' },
					{ value: 18, name: '스피크MTM_검정 9' },
